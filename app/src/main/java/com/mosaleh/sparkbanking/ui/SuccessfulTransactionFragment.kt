 ...
 * Use the [SuccessfulTransactionFragment.newInstance] factory method to
...
class SuccessfulTransactionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SuccessfulTransactionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SuccessfulTransactionFragment().apply {
